...
-- Set default folding to tresitter
...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>ht", builtin.git_status, { desc = "[F]ind by Git Status" })
	...
	{ -- LSP Configuration & Plugins
		...
		dependencies = {
			...
			-- `lsp_signature` shows function signature when writing args
			...
			require("mason-lspconfig").setup({
				...
				handlers = {
					function(server_name)
						...
						server.on_init = function(_)
							vim.notify(server_name, vim.log.levels.ERROR)
	...
	require("kickstart.plugins.gitlinker"), -- adds gitsigns recommend keymaps
